...
// I have set up all the tools from this line
  const context = canvas.getContext("2d");

// i am giving my height and width from these two lines
canvas.width = window.innerWidth;
canvas.height = window.innerHeight;

// whenever I am resizing from these two ByteLengthQueuingStrategy, whenever I am changing the height and width.
